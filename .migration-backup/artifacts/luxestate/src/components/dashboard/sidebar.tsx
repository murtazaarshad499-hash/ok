...
const navItems = [
  ...
  { href: "/dashboard/lead-intake", label: "Lead Intake", icon: GitMerge },
        ...
        <div className={cn("flex items-center gap-2", collapsed && "flex-col")}>
          ...
          {!collapsed && (
            <div className="flex min-w-0 flex-1 flex-col pl-1">
              <p className="truncate text-sm font-medium text-sidebar-foreground">James Donovan</p>
              <p className="truncate text-xs text-muted-foreground">Senior Agent</p>
            </div>
          )}
        </div>
      </div>
