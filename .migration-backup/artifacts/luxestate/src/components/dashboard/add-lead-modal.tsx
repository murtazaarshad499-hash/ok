...
import { User, Mail, Phone, DollarSign, Building2, UserCheck, StickyNote } from "lucide-react"
...
export function AddLeadModal({ open, onClose, onAdd }: Props) {
  ...
  const priorityOptions: { value: LeadPriority; label: string; color: string }[] = [
        ...
        <div className="grid gap-4 py-2">
          ...
          <div className="grid gap-1.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={cn("pl-8", surfaceInputClass, errors.name && "border-red-500")}
              />
            </div>
          ...
          <div className="grid gap-1.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={cn("pl-8", surfaceInputClass, errors.email && "border-red-500")}
              />
            </div>
            ...
            <div className="grid gap-1.5">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className={cn("pl-8", surfaceSelectClass)}
                >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="grid gap-1.5">
              ...
              <div className="relative">
                <UserCheck className="absolute left-3 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-muted-foreground pointer-events-none" />
                <select
          ...
          {/* Notes */}
          <div className="grid gap-1.5">
            <Label className="text-xs font-medium text-muted-foreground">Initial Notes</Label>
            <div className="relative">
              ...
              <textarea
                ...
                rows={2}
                className={cn(
                  "w-full resize-none rounded-xl border bg-secondary/20 pl-8 pr-3 py-2.5 text-sm text-foreground placeholder:text-muted-foreground outline-none focus:ring-2 focus:ring-primary/30 border-border/50",
                )}
              />
            </div>
          </div>
